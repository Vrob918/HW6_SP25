...
def main():
    rankine1 = rankine(p_low=8, p_high=8000, t_high=500, name='Example Rankine Cycle') #instantiate a rankine object to test it.
    #t_high is specified
    #if t_high were not specified, then x_high = 1 is assumed
    eff=rankine1.calc_efficiency()
    print(f'Calculated Efficiency: {eff:.2f}%')
